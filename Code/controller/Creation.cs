...
namespace Project
{
    public class CreationSalle
    {
        ...
        public void CreateWaiters()
        {
            foreach (Square square in model.restaurationRoom.squares)
            {
                ...
                {
                    waiter.sprite = new Sprite(new Point(288, 128), form.spriteController, GesRestaurant.Properties.Resources.DwarfSprites, 32, 32, 200, 3);
        ...
        public void CreateHeadWaiter()
        {
            foreach (Square square in model.restaurationRoom.squares)
            {
                square.headWaiter.sprite = new Sprite(new Point(0, 128), form.spriteController, GesRestaurant.Properties.Resources.DwarfSprites, 32, 32, 200, 3);
    ...
    public class CreationCuisine
    {
        ...
        public void CreateCook()
        {
            ...
            {
                cook.sprite = new Sprite(new Point(96, 0), form.spriteController, GesRestaurant.Properties.Resources.Link, 32, 32, 200, 3);
        ...
        {
            model.kitchen.kitchenChef.sprite = new Sprite(new Point(286, 0), form.spriteController, GesRestaurant.Properties.Resources.Link, 32, 32, 200, 3);
        ...
        {
            model.kitchen.plong.sprite = new Sprite(new Point(96, 128), form.spriteController, GesRestaurant.Properties.Resources.Link, 32, 32, 200, 3);
    ...
    public class CreationClient
    {
        ...
        public void CreateClient()
        {
            ...
            {
                client.sprite = new Sprite(new Point(286, 0), form.spriteController, GesRestaurant.Properties.Resources.Link, 32, 32, 200, 3);
